...
strCmdLine = WshShell.RegRead("HKLM\SOFTWARE\Microsoft\VisualStudio\16.0\InstallDir")
' In case of error assume WoW64 case
If Err <> 0 Then
  On Error Goto 0
  strCmdLine = WshShell.RegRead("HKLM\SOFTWARE\Wow6432Node\Microsoft\VisualStudio\16.0\InstallDir")
End If
